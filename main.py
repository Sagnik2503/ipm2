...
crew=Crew(
    agents=[document_info_agent, market_analysis, news_scraper, risk_assessment_agent,final_integration_agent],
    tasks=[document_query_task, market_analysis_task, analyze_scraped_content_task, project_risk_assessment_task,final_integration_task],
